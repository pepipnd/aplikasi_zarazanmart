...
class Products_model extends CI_Model {
    ...
    public function getProductsLimit(){
        $query = "SELECT NAMA,tbl_stok.STOK_AWAL,GAMBAR,HARGA_JUAL,produk.KODE_BARANG,SATUAN, tbl_stok.STOK_TAMBAH, tbl_stok.STOK_TERJUAL FROM produk LEFT JOIN tbl_stok ON
        produk.KODE_BARANG = tbl_stok.KODE_BARANG WHERE STOK_AWAL + STOK_TAMBAH - STOK_TERJUAL > 5 LIMIT 10";
    ...
    public function getProductById($id){
        $this->db->select("NAMA,tbl_stok.STOK_AWAL,GAMBAR,HARGA_JUAL,produk.KODE_BARANG,SATUAN,ISI, tbl_stok.STOK_TAMBAH, tbl_stok.STOK_TERJUAL");
        $this->db->from("produk");
        $this->db->join("tbl_stok", "tbl_stok.KODE_BARANG = produk.KODE_BARANG");
        $this->db->where('produk.KODE_BARANG', $id);
    ...
    function detailtrs($id)
    {
        ...
        $this->db->join('produk','produk.KODE_BARANG = transaksi_detail.produk_id','right');
